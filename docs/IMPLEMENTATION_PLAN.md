...
| 7 | Full local study and primary analysis | Complete manifests, intervals, ablations and headroom report | Stage 6 + Gate E | pending |
| 8 | Hardware preflight and explicitly authorised block | Balance, free plan, budgets, pinned matrix and resumable intent | Stage 7 + Gates E-F + user hardware authorization | pending |
| 9 | Hardware analysis and conditional boundaries | Raw job evidence, usage reconciliation and bounded conclusions | Stage 8 | pending |
| 10 | Reproducibility release and later article | Clean-room reproduction, claims ledger and reviewed outputs | Stage 7 or 9 as applicable | pending |

At stages 3-6 a defect can trigger redesign before the test split is opened. At stage 7 or later, a substantive methodological change creates a protocol amendment.
