# Phases 1–6 final acceptance report v3
...
| 6 A4 | This run `3de109c7-30d9-4cb0-827f-dbd82c4c509d` (`INCOMPLETE_ENGINEERING`; admission NOT_ADMITTED) | A3 scientific conclusions | Corpus 120/80/24 not started; Gates E/F FAIL | **not** a completed Phase 6 scientific closure |
