        ...
        for kind, cid, detail in fired:
            ...
            if kind == "lap_complete" and not car["in_pit"]:
                ...
                self._log(
                    ...
                    cid,
                    {
                        "t_in_s": self.state["pit_parts"]["t_in_s"],
                        "pit_entry_completed_laps": int(car["pit_entry_completed_laps"]),
                        "completed_laps": int(car["completed_laps"]),
                    },
                )
            elif kind == "pit_timer":
        ...
        if phase == "service":
            ...
            self._log(
                ...
                car["car_id"],
                {
                    ...
                    "completed_laps_at_service": int(car["completed_laps"]),
                    "note": "service_complete is not the pit-entry lap; use pit_entry event / pit_entry_completed_laps",
                },
            )
            return
